...
require 'nz_mps_popolo/serializers/base_serializer'
require 'nz_mps_popolo/serializers/person_serializer'
require 'nz_mps_popolo/serializers/organization_serializer'
require 'nz_mps_popolo/serializers/membership_serializer'
require 'nz_mps_popolo/serializers/post_serializer'
